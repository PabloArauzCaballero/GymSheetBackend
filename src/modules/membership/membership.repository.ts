...
export class MembershipRepository {
  constructor(
    @InjectModel(MembershipPlanModel) private readonly plans: typeof MembershipPlanModel,
    @InjectModel(PlanAccessScopeModel) private readonly planScopes: typeof PlanAccessScopeModel,
    @InjectModel(MembershipModel) private readonly memberships: typeof MembershipModel,
    @InjectModel(CustomerProfileModel) private readonly customers: typeof CustomerProfileModel,
    @InjectModel(StaffProfileModel) private readonly staff: typeof StaffProfileModel,
    @InjectModel(StaffBranchScopeModel) private readonly staffScopes: typeof StaffBranchScopeModel,
  ) {}

  listPlans() { return this.plans.findAll({ include: [PlanAccessScopeModel], order: [['name', 'ASC']] }); }
