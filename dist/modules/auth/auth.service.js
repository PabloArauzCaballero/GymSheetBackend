...
let AuthService = class AuthService {
    ...
    async register(input) {
        ...
        if (existingUser) {
            throw new common_1.ConflictException('Ya existe una cuenta registrada con este correo.');
        }
        const passwordHash = await bcrypt.hash(input.password, env_1.env.BCRYPT_SALT_ROUNDS);
    ...
    buildAuthResponse(userId, email, rol, nombreCompleto) {
